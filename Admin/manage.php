...
<body class="cont">
	...
	<main>
		...
		<div class="msgs">
			<?php
				if (empty($total_all)) {
					echo '<h5 class="error">No User Record Available</h5>';
				}
				if (isset($_GET["error"])) {
		...
		<aside class="menu">
			<div>
				<ul type="square">
					...
					<li><b>APPLICATIONS:</b>
						<ul>
							<li><a class="aside-links" href="view_withdrawal.php"><?php echo "$count_with_apps";?> Withdraw Apps</a>
							</li>
							<li><a class="aside-links" href="view_readmission.php"><?php echo "$count_read_apps";?> Readmission Apps</a></li>
						</ul>
					</li><br>
					<li><b>PROFILE:</b>
						 <ul>
			...
			<div class="col-md-10" id="col">
				...
				<div class="wrapper">	
					<table class="table">
						...
						<tbody>
							<tr>
								<?php while ($recs = mysqli_fetch_assoc($rows_all)): ?>
