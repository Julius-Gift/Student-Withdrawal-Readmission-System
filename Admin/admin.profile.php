...
<body class="cont">
	...
	<div>
				...
				<ul type="square">
					...
					<li><b>APPLICATIONS:</b>
						<ul>
							...
							<li><a class="aside-links" href="view_readmission.php">
									<?php 
										echo "$count_read_apps";
									?> 
									Readmission Apps</a>
							</li>
						</ul>
		...
		<main>
			<div class="row">
				<div class="prof-pic">
					<img src="images/avatar.png" height="90" width="90">
				</div>
				<div class="prof">
					<label>Full Name:</label><br>
					<div class="dets">
						<a href="editname.php"><?php echo $profile_collection["fullname"]?></a>	
					</div>
				</div>
				<div class="prof">
					<label>Username:</label>
					<div class="dets">
						<a href="editcomp.php"><?php echo $profile_collection["username"]?></a>	
					</div>
				</div>
				<div class="prof">
					<label>Email:</label>
					<div class="dets">
						<a href="editmail.php"><?php echo $profile_collection["email"]?></a>	
					</div>
				</div>
			</div>
		</main>		
