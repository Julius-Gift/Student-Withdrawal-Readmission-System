					...
					<li><b>APPLICATIONS:</b>
						<ul>
							<li>
								...
								<?php echo "$count_with_apps";?> Withdraw Apps</a>
							</li>
							<li>
								<a class="aside-links" href="view_readmission.php">
								<?php echo "$count_read_apps";?> Readmission Apps</a>
							</li>
						</ul>
					</li><br>
					<li><b>PROFILE:</b>
			...
			<div class="col-md-10" id="col">
				...
				<div class="wrapper">	
					<table class="table">
						...
						<tbody>
							<tr>
								<?php while ($recs = mysqli_fetch_assoc($rows_staff)): ?>
